...
def main():
    ...
    request: CreateAppTableRecordRequest = CreateAppTableRecordRequest.builder() \
        .app_token("U4JJb6P6daGyUCsx62Cc8UT9nqg") \
        .table_id("tblUbajynZEYnIUk") \
        .request_body(AppTableRecord.builder()
            .fields({"待办事项":"拜访潜在客户","截止日期":1674206443000,"描述":"","标签":["宝宝用品"]})
            .build()) \
        .build()

    # 发起请求
    option = lark.RequestOption.builder().user_access_token("u-enkpGtx75fCoNyd56aMuv.lgllKQk0gVM0G0lhkw0zGC").build()
